...
```{r}
fname = system.file("extdata/2023-01-16.tcx", package = "ConconiAnaerobicThresholdTest")
...
```{r}
fname = system.file("extdata/2023-09-15.tcx", package = "ConconiAnaerobicThresholdTest")
...
```{r}
fname = system.file("extdata/2022-01-10.tcx", package = "ConconiAnaerobicThresholdTest")
dat202201 <- prepdata(fname, startminutes = 26, endminutes = 38.99,
          useDeviceSpeed = FALSE)
